...
class DockerWorkspace(RemoteWorkspace):
    ...
    keep_alive: bool = Field(
        default=False,
        description="Keep container running after workspace exit (skip stop/rm).",
    )
    ...
    def cleanup(self) -> None:
        ...
        if self._container_id:
            ...
            if self.keep_alive:
                logger.info(f"Keeping container alive: {self._container_id}")
            else:
